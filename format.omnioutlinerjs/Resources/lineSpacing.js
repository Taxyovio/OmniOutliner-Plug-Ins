...
var _ = (function () {
	var action = new PlugIn.Action(function (selection, sender) {
		...
		var fontSize = parseFloat(
			document.outline.baseStyle.get(Style.Attribute.FontSize).toString()
		);
		var curSpacing = parseFloat(
			document.outline.baseStyle
				.get(Style.Attribute.ParagraphLineSpacing)
				.toString()
		);
